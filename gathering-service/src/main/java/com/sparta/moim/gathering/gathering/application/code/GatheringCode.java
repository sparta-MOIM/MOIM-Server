...
public enum GatheringCode implements Code {
  ...
  NOT_CONNECTED_INFRA(HttpStatus.INTERNAL_SERVER_ERROR,"G008", "connected error"),
  NOT_JOIN_GATHERING(HttpStatus.BAD_REQUEST,"G009", "the gathering could not be joined"),
  ;
